/*
  ...
  This file is part of MouseControl.
    ...
    it under the terms of the GNU General Access License as published by
    ...
    GNU General Access License for more details.

    You should have received a copy of the GNU General Access License
...
namespace HLab.Erp.Lims.Monographs.Module.Geo
{
    public enum Side
    {
        None,
