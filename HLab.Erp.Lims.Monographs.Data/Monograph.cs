...
namespace HLab.Erp.Lims.Monographs.Data
{
    ...
    public partial class Monograph : Entity
    {
        ...
        readonly IProperty<int?> _pharmacopoeiaId = H.Property<int?>();
        ...
        readonly IProperty<Pharmacopoeia> _pharmacopoeia = H.Property<Pharmacopoeia>(c => c.Foreign(e => e.PharmacopoeiaId));
        ...
        readonly IProperty<byte[]> _document = H.Property<byte[]>(c => c.Default((byte[])null));
        ...
        readonly IProperty<string> _documentFormat = H.Property<string>(c => c.Default(""));
        ...
        readonly IProperty<int?> _innId = H.Property<int?>(c => c.Default((int?)null));
        ...
        readonly IProperty<Inn> _inn = H.Property<Inn>(c => c.Foreign(e => e.InnId));
        ...
        readonly IProperty<int?> _formId = H.Property<int?>();
        ...
        readonly IProperty<Form> _form = H.Property<Form>(c => c.Foreign(e => e.FormId));
        ...
        IProperty<ObservableQuery<MonographConsumable>> _consumables =
        ...
        readonly IProperty<ObservableQuery<MonographTest>> _tests =
        ...
        readonly IProperty<string> _graphSource = H.Property<string>(c => c.Default(""));
